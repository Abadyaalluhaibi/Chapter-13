...
public class JFrameMain extends JFrame {
	...
	public JFrameMain() {
		...
		JButton buttonDoimand = new JButton("13-2");
		buttonDoimand.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				
				// generate diamond pattern - Exercis 13-2
				//same input, output as 13-1
				//widest point in diamond is to be n 
				int n = Integer.parseInt(textFieldEx1.getText());
				String sPattern = Recursion.strDiamond( 1, n);
				txtAnswer13_1.append("\n Exercise 13-2 \n" + sPattern);
			}
		});
		buttonDoimand.setFont(new Font("Tahoma", Font.PLAIN, 26));
		buttonDoimand.setBounds(245, 179, 176, 56);
		contentPane.add(buttonDoimand);
	}
}
